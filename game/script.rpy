...
label robotics_day2:
    ...
    menu:
        ...
        "What was the disagreement":
            c"If you dont mind me asking, what was the disagreement?"
            narrator"She chuckled softly"
            h"I guess I did open the conversation to that"
            h"We uh, we used to work together on the uhh....gardening club"
            narrator"Callista raised her eyebrow"
            c"You were apart of the gardening club?"
            h"Yeah, uh we started it together. We added our friends into it"
            h"It was great"
            h"That was until um.."
    ...
    narrator"She looked out the window, prompty looking away from Callista"
    h"we were so calm, he was an escape from everything"
    narrator"Callista had a feeling that Hannah wasn't talking about the gardening club"
    h"After our friend died, we had a falling out with how we were coping"
    h"I didn't want to do with anything and I guess I got obsessed with control"
    narrator"She looked at her, watery eyes and all"
    h"I miss him though and perhaps uh, yk the version of me then"
    narrator"She waved her hand away"
    h"It's stupid"
    c"No, its not"
    narrator"She lowered her voice to whisper"
    c"Your friend would have definetly not have thought so"
    h"How would you know that?"
    c"She was my sister"
    h"..oh?"
    c"My sister spoke very highly of you guys"
    narrator"Callista now had Hannah's attention. She looked at Callista with an intense focus"
    narrator"As if in a daze"
    c"She told me about her friends at the gardening club, and the flowers she planted."
    c"She used to tell me that you and Jason were a good couple. Always teasing each other and playing around"
    c"Said you guys was the kind of love she wished she had"
...
label newspaper_day2:
    ...
    c"Anyways, about the story"
    an"Ah right"
    c"How did you want to write it?"
    an"Kind of like a guide to high school maybe or a recount of my memories"
    an"Im trying not to make it seem too self centered"
    narrator"The two spent the rest of the time of the rest of the time drafting out an idea for the new paper"
    narrator"After the two finished talked for a bit they cooled down and just started talking"
    c"So, what made you start the newspaper club?"
    narrator"He spit out his drink slightly and softly chuckled"
    an"Start the newspaper club? No no, what made you think that?"
    c"Well manu of the current club leaders founded thei clubs"
    an"Well I just joined the newspaper club"
    an"I guess people talk more about the structure I gave the club"
    c"Oh"
    an"Yeah"
    an"It's embarassing, but I joined the newspaper club because of a girl"
    narrator"She raised her eyebrow"
    c"So you wanted to impress her"
    an"No no, that isn't it at all"
    c"certainly how it sounds"
    narrator"She took a sip of her drink(of which she got on sale this time!) and aised her eyebrow"
    an"She is the one who gave me the idea to join the newspaper club"
    an"I want to be a writer"
    c"Oh I could've guessed that"
    an"That obvious huh"
    an"But my family really looks down to people in the arts"
    an"Even more so men"
    an"That I am suppose to be a provider and all"
    c"Oh, im sorry"
    an"Don't be, its seriously not your fault"
    an"But my friend, she like... took me up to New York"
    an"She took me to the book store and author talks"
    c"Took you to New York for all that?"
    an"Yeah, she was incredible"
    an"It was that trip that imspired me to join the Newpaper club"
    an"Then all we did was write sports papers and student recognition"
    an"I began to suggest different ideas and reformation of the club"
    an"The trip inspired me a lot so I began to organize it strongly"
    c"That's amazing"
    c"Is your friend really into writing too"
    an"No, well, yes."
    an"She was really into everything too"
    an"Robotics, gardening, newspaper...cheerleading"
    c"{i}was{i}"
    c"..."
...
label post_fight:
    ...
    c"Oh? What are you working on"  
    narrator"He taked out a file and show it to her"
    narrator"Inside the file were a snippets of his high school year and diary entries"
    an"I want to write about my high school experience"
    c"How did you want to write it?"
    an"Kind of like a guide to high school maybe or a recount of my memories"
    an"Im trying not to make it seem too self centered"
    narrator"The two spent the rest of the time of the rest of the time drafting out an idea for the new paper"
